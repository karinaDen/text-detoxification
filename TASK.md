...
The dataset is a subset of the ParaNMT corpus (50M sentence pairs). The filtered ParaNMT-detox corpus (500K sentence pairs) can be downloaded from [here](
    filtered_paranmt.zip). This is the main dataset for the assignment detoxification task.
